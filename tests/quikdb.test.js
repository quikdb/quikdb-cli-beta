...
describe('QuikDB Class Integration Tests', () => {
    ...
    const mockDeclarationsPath = path_1.default.join(require('os').homedir(), '.quikdb', 'quikdb', 'src', 'declarations', 'database');
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        quikDB = new controllers_1.QuikDB(mockDeclarationsPath);
        yield quikDB.init();
    ...
    describe('Initialization', () => {
        it('should initialize correctly with valid configuration and connect to the canister', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('Canister Methods: Schema', () => {
        it('should create a new schema successfully', () => __awaiter(void 0, void 0, void 0, function* () {
            const fields = [
                { name: 'username', fieldType: 'Text' },
                { name: 'age', fieldType: 'Int' },
            ];
            const indexes = ['username'];
            const args = [schemaName, fields, indexes];
            const result = yield quikDB.callCanisterMethod(_types_1.CanisterMethod.CreateSchema, args);
            console.log('createSchema Result:', result);
            expect(result).toHaveProperty('ok', true);
            const getSchemaArgs = [schemaName];
            const schemaResult = yield quikDB.callCanisterMethod(_types_1.CanisterMethod.GetSchema, getSchemaArgs);
        ...
        it('should list all schemas successfully', () => __awaiter(void 0, void 0, void 0, function* () {
            const listSchemaArgs = [];
            const schemaResult = yield quikDB.callCanisterMethod(_types_1.CanisterMethod.ListSchemas, listSchemaArgs);
        ...
        it('should return error when creating a schema that already exists', () => __awaiter(void 0, void 0, void 0, function* () {
            const fields = [
        ...
        it('should delete schema successfully', () => __awaiter(void 0, void 0, void 0, function* () {
            const deleteSchemaArgs = [schemaName];
            const deleteSchemaResult = yield quikDB.callCanisterMethod(_types_1.CanisterMethod.DeleteSchema, deleteSchemaArgs);
